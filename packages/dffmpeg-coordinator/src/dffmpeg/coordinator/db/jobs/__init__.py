...
class JobRepository(BaseDB):
    ...
    table = Table(
        "jobs",
        metadata,
        Column("job_id", String(26), primary_key=True),
        Column("requester_id", String(255), ForeignKey("auth.client_id"), nullable=False),
        ...
        Column("callback_transport", String(50), nullable=False),
